      ...
      <Col span="24">
        <Card>
          <p slot="title" style="height: 32px">
            ...
            <Button type="success" @click="oneTouch" icon="md-create" style="margin-left: 16px;">一键生成</Button>
          </p>
          ...
          <div>
            <Form ref="myForm" :model="baseConfig" :label-width="110">
              ...
              <FormItem label="后端文件配置：">
                <Input style="width: 150px;" v-model="baseConfig.backControllerName" clearable placeholder="请输入后端控制器名称"></Input>
                <Input style="width: 150px;" v-model="baseConfig.backLogicName" clearable placeholder="请输入后端逻辑名称"></Input>
                <Input style="width: 150px;" v-model="baseConfig.backModelName" clearable placeholder="请输入后端模型名称"></Input>
                <div>
                  ...
                  <p style="display: inline-block; width: 150px; font-size: 12px; color: #ed4014;">
                    <span v-if="baseConfig.backLogicName.trim()" style="color: #515a6e;"><Icon type="ios-alert-outline" size="12"/> 后端逻辑名称</span>
              ...
              <FormItem label="前端文件配置：">
                <Input style="width: 150px;" v-model="baseConfig.frontModelName" clearable placeholder="请输入前端文件模块名称"></Input>
                <Input style="width: 150px;" v-model="baseConfig.frontGroupName" clearable placeholder="请输入前端文件组名称"></Input>
                <Input style="width: 150px;" v-model="baseConfig.frontVueName" clearable placeholder="请输入前端vue文件名称"></Input>
                <div>
                  <p style="display: inline-block; width: 150px; font-size: 12px; color: #ed4014;">
                  ...
                  <p style="display: inline-block; width: 150px; font-size: 12px; color: #ed4014;">
                    <span v-if="baseConfig.frontVueName.trim()" style="color: #515a6e;"><Icon type="ios-alert-outline" size="12"/> 前端vue文件名称</span>
  ...
  const checkbox = (vm, h, currentRow, index, data, dataOther = '') => {
      ...
      return h('Checkbox', {
          ...
          on: {
              'on-change': (res) => {
                  if (res === true) {
                      vm.setData(data, index, currentRow.Field, vm.tableData[index].Comment, dataOther)
                  } else {
